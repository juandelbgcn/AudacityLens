...
#[derive(Debug)]
pub struct AudacityLensProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AudacityLensProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AudacityLens processing");
    
    let mut processor = AudacityLensProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AudacityLensProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AudacityLensProcessor::new(false);
